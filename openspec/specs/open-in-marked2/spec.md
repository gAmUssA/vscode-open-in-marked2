...
The extension SHALL provide a command that opens the currently active Markdown file in the Marked 2 application.
...
#### Scenario: Non-Markdown file active

- **WHEN** user executes the "Open in Marked 2" command with a non-Markdown file active
- **THEN** the system displays an error message "Current file is not a Markdown file"
...
- **THEN** the system treats it as a valid Markdown file for the Open in Marked 2 command
